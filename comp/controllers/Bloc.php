...
class Bloc extends CI_Controller
{
	...
	public function ajax_list()
	{
		...
		foreach ($list as $line) {
				...
				$row[] = '<a class="btn btn-sm btn-warning"  title="Modifier" onclick="toJsonFile('.$line->AppID.')"><i class="glyphicon glyphicon-pencil"></i></a>';
	...
	public function add()
	{
		...
		$data2["JsonFileName"] = $this->input->post('JsonFileName').'.json';
