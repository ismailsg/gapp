						...
						<form action="#" id="form" class="form-horizontal">
							<input type="hidden" value="" name="id"/> 
	              			<div class="form-body"> 
								...
								<div class="form-group">
									<div class="col-md-11">
										<input name="JsonFileName" placeholder="JsonFileName" class="form-control" type="text" id="JsonFileName" value="<?php echo $seulLine->JsonFileName; ?>">
	               				...
	               				<div class="row" id="ligne0"> <!-- adAppId -->
									...
									<div class="form-group col-md-8">
										<div class="col-md-12">
											<input name="BlocValue[0]" placeholder="adAppId" class="form-control" type="text" id="BlocValue[0]" value="<?php echo mulLine[]->?>">
											<span class="help-block"></span>
										</div>
									</div>			
								</div>
								
								<div class="row" id="ligne1"> <!-- appName -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne2"> <!-- startApp -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne3"> <!-- adCounter -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne4"> <!-- storeName -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne5"> <!-- packageName -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne6"> <!-- packageNameNextApp -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne7"> <!-- linkCPA -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne8"> <!-- isCPAactive -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne9"> <!-- titleCPA -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne10"> <!-- messageCPA -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne11"> <!-- bannerFB_1 -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne12"> <!-- bannerFB_2 -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne13"> <!-- bannerFB_3 -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne14"> <!-- nativeFB_1 -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne15"> <!-- nativeFB_2 -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne16"> <!-- nativeFB_3 -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne17"> <!-- interstitialFB_1 -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne18"> <!-- interstitialFB_2 -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne19"> <!-- interstitialFB_3 -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne20"> <!-- bannerAd_1 -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne21"> <!-- bannerAd_2 -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne22"> <!-- bannerAd_3 -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne23"> <!-- nativeAd_1 -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne24"> <!-- nativeAd_2 -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne25"> <!-- nativeAd_3 -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne26"> <!-- interstitialAd_1 -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne27"> <!-- interstitialAd_2 -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
								...
								<div class="row" id="ligne28"> <!-- interstitialAd_3 -->
									<div class="form-group col-md-3">
										<div class="col-md-12">
...
<script src="<?php echo base_url() . 'assets/myjs/jsonfile.js'?>"></script>